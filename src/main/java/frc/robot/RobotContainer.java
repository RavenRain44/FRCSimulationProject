...
import frc.robot.commands.BareboneAutoCommand;
...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        driveSubsystem.setDefaultCommand(new TeleopDriveCommand(driveSubsystem, driver));
    ...
    public Command getAutonomousCommand()
    {
        ...
        return new BareboneAutoCommand(driveSubsystem);
    }
}
